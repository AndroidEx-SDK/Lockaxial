...
export function registerScreens() {
    ...
    Navigation.registerComponent('LoginScreen', () => LoginScreen);//登录页面,当检测未登录时，显示此页面进行登录
    Navigation.registerComponent('RegisterScreen', () => RegisterScreen);//注册页面,没有登录账号时，显示此页面进行注册
    ...
    Navigation.registerComponent('UnitCarScreen', () => UnitCarScreen);//车辆明细页面
    ...
    Navigation.registerComponent('UnitBlockScreen', () => UnitBlockScreen);//房屋申请-选择楼栋
    ...
    Navigation.registerComponent('ShopDetailScreen', () => ShopDetailScreen);//铺详情页面
